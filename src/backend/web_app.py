...
from backend.config import WebAppConfig
from backend.service import PaperSummaryService
...
def main() -> None:
    ...
    uvicorn.run("backend.web_app:app", host="127.0.0.1", port=8000, reload=False)
